...
/*   Updated: 2024/05/24 19:21:20 by ukireyeu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_node	*find_closest_smaller(t_node *node_a, t_node *stack_b)
{
	t_node	*max_node_b;
...
void	set_tagrets_a(t_node *stack_a, t_node *stack_b)
{
	...
	while (stack_a)
	{
		...
		stack_a->target_node = find_closest_smaller(stack_a, stack_b);
